# -*- coding: utf-8 -*-
"""
Created on Thu Apr 21 05:56:51 2022
...
def load_data(dataset_str):
    ...
    for i in range(len(names)):
        with open("/Users/wangz/Desktop/bgcn2/python/data/ind.{}.{}".format(dataset_str, names[i]), 'rb') as f:
    ...
    test_idx_reorder = parse_index_file("/Users/wangz/Desktop/bgcn2/python/data/ind.{}.test.index".format(dataset_str))
